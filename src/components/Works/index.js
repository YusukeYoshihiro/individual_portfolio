...
import Icon3 from '../../assets/images/ysfilmImg.png';
import Icon4 from '../../assets/images/ecommerse_mern_shop_app.png';
    ...
    <WorksContainer name="works" basename="works">
      ...
      <WorksWrapper>
        ...
        <WorksCard data-aos="zoom-in" data-aos-duration="1000"  >
          ...
          <WorksContent>
            <TextCtn>
              <WorksH2>E-commerse App</WorksH2>
              <WorksP>Built E-commerse App with <br />
                MERN Stack</WorksP>
              <LinkMore
                  to={'/ecommerce'}
                  duration={500}
